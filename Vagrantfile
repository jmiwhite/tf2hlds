...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "joshuamw-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/shef"
  #   chef.validation_client_name = "shef-validator"
  #   chef.validation_key_path = ".chef/shef-validator.pem"
  # end
end
